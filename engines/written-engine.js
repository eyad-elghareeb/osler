...
(function () {
  ...
  function initMarkup() {
    ...
    app.innerHTML = [
      ...
      '    Back to Hub',
      '  </a>',
      '  <button class="btn btn-icon" id="theme-start" type="button" title="Toggle theme" aria-label="Toggle theme">'+EngineShared.icon('sun')+'</button>',
      ...
      '            <button class="btn btn-icon settings-gear" id="settings-btn" type="button" title="API Key Settings '+EngineShared.icon('settings')+'" aria-label="API Key Settings">'+EngineShared.icon('settings')+'</button>',
      '          </div>',
      ...
      '      <button class="icon-btn" id="flag-question" type="button" title="Flag question" aria-label="Flag question">'+EngineShared.icon('flag')+'</button>',
      '      <a class="icon-btn" href="index.html" id="hub-link-practice" title="Back to Hub" aria-label="Back to Hub">'+EngineShared.icon('home')+'</a>',
      '      <button class="icon-btn" id="theme-practice" type="button" title="Toggle theme" aria-label="Toggle theme">'+EngineShared.icon('sun')+'</button>',
      '      <button class="icon-btn danger" id="reset-progress" type="button" title="Reset Progress" aria-label="Reset Progress">↻</button>',
      '    </div>',
      '  </header>',
      ...
      '    <div class="topbar-actions">',
      '      <a class="icon-btn" href="index.html" id="hub-link-result" title="Back to Hub" aria-label="Back to Hub">'+EngineShared.icon('home')+'</a>',
      '      <button class="icon-btn" id="theme-result" type="button" title="Toggle theme" aria-label="Toggle theme">'+EngineShared.icon('sun')+'</button>',
      '      <button class="icon-btn danger" id="reset-result" type="button" title="Reset Progress" aria-label="Reset Progress">↻</button>',
      '    </div>',
      '  </header>',
      ...
      '      <button class="icon-btn" id="camera-close-btn" type="button" title="Close" aria-label="Close">'+EngineShared.icon('x')+'</button>',
      '    </div>',
      ...
      '        <button class="btn btn-primary" id="camera-capture-btn" type="button" aria-label="Capture photo" style="width:56px;height:56px;border-radius:50%;font-size:1.8rem;padding:0;display:flex;align-items:center;justify-content:center">●</button>',
      '        <button class="btn btn-icon" id="camera-switch-btn" type="button" title="Switch camera" aria-label="Switch camera">'+EngineShared.icon('refresh-cw')+'</button>',
      '      </div>',
      '    </div>',
      ...
      '      <button class="icon-btn" id="settings-close-btn" type="button" title="Close" aria-label="Close">'+EngineShared.icon('x')+'</button>',
      '    </div>',
    '    <div class="field-box">',
      ...
      '        <button class="btn btn-icon" id="settings-key-toggle" type="button" title="Show/Hide key" aria-label="Show/Hide key">'+EngineShared.icon('eye')+'</button>',
      '      </div>',
