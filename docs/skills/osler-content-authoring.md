...
This document is a portable reference guide for authoring, editing, and managing medical content across all Osler learning engines (Quiz, QBank, Flashcards, OSCE stations, Written prompts, Videos, Library articles with HTML & sidecar metadata) and understanding smart manifest synchronization.
