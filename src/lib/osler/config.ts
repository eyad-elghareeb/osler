...
export const DEFAULT_CONFIG: OslerConfig = {
  ...
  themes: {
    ...
    custom: [
      ...
      /* ── Apple colorway homages ──────────────────────────────────────────
       * Two families drawn from Apple's hardware colorways, chosen so no
       * primary hue collides with the families above:
       *   • Starlight — warm champagne/gold on warm ivory (light) and warm
       *     near-black (dark). Soft, elegant, low-chroma.
       *   • Sky Blue  — bright azure on cool white (light) and deep
       *     blue-slate (dark). Crisp and airy. */
      {
        id: "starlight",
        name: "Starlight",
        variant: "dark",
        primary: "oklch(0.78 0.09 85)",
        accent: "oklch(0.5 0.05 80)",
        background: "oklch(0.16 0.012 80)",
        foreground: "oklch(0.95 0.008 85)",
        card: "oklch(0.21 0.014 80)",
        cardForeground: "oklch(0.95 0.008 85)",
        popover: "oklch(0.23 0.015 80)",
        popoverForeground: "oklch(0.95 0.008 85)",
        primaryForeground: "oklch(0.18 0.015 80)",
        secondary: "oklch(0.28 0.016 80)",
        secondaryForeground: "oklch(0.95 0.008 85)",
        muted: "oklch(0.25 0.014 80)",
        mutedForeground: "oklch(0.72 0.015 85)",
        destructive: "oklch(0.68 0.21 22)",
        border: "oklch(1 0 0 / 8%)",
        input: "oklch(1 0 0 / 10%)",
        ring: "oklch(0.78 0.09 85)",
        sidebar: "oklch(0.19 0.013 80)",
        sidebarForeground: "oklch(0.95 0.008 85)",
        sidebarPrimary: "oklch(0.78 0.09 85)",
        sidebarPrimaryForeground: "oklch(0.18 0.015 80)",
        sidebarAccent: "oklch(0.28 0.016 80)",
        sidebarAccentForeground: "oklch(0.95 0.008 85)",
        sidebarBorder: "oklch(1 0 0 / 6%)",
        sidebarRing: "oklch(0.78 0.09 85)",
      },
      {
        id: "starlight-light",
        name: "Starlight Light",
        variant: "light",
        primary: "oklch(0.5 0.075 80)",
        accent: "oklch(0.65 0.09 85)",
        background: "oklch(0.975 0.007 95)",
        foreground: "oklch(0.22 0.012 80)",
        card: "oklch(1 0 0)",
        cardForeground: "oklch(0.22 0.012 80)",
        popover: "oklch(1 0 0)",
        popoverForeground: "oklch(0.22 0.012 80)",
        primaryForeground: "oklch(0.99 0.005 95)",
        secondary: "oklch(0.945 0.01 95)",
        secondaryForeground: "oklch(0.24 0.014 80)",
        muted: "oklch(0.945 0.01 95)",
        mutedForeground: "oklch(0.47 0.015 85)",
        destructive: "oklch(0.58 0.24 27)",
        border: "oklch(0.9 0.012 90)",
        input: "oklch(0.9 0.012 90)",
        ring: "oklch(0.5 0.075 80)",
        sidebar: "oklch(0.96 0.009 95)",
        sidebarForeground: "oklch(0.22 0.012 80)",
        sidebarPrimary: "oklch(0.5 0.075 80)",
        sidebarPrimaryForeground: "oklch(0.99 0.005 95)",
        sidebarAccent: "oklch(0.93 0.014 90)",
        sidebarAccentForeground: "oklch(0.24 0.014 80)",
        sidebarBorder: "oklch(0.9 0.012 90)",
        sidebarRing: "oklch(0.5 0.075 80)",
      },
      {
        id: "sky-blue",
        name: "Sky Blue",
        ...
        cardForeground: "oklch(0.95 0.01 235)",
        popover: "oklch(0.22 0.026 245)",
        popoverForeground: "oklch(0.95 0.01 235)",
        primaryForeground: "oklch(0.15 0.03 240)",
        secondary: "oklch(0.27 0.03 245)",
        secondaryForeground: "oklch(0.95 0.01 235)",
        muted: "oklch(0.24 0.024 245)",
        mutedForeground: "oklch(0.72 0.02 240)",
        destructive: "oklch(0.68 0.21 22)",
        border: "oklch(1 0 0 / 8%)",
        input: "oklch(1 0 0 / 10%)",
        ring: "oklch(0.75 0.12 230)",
        sidebar: "oklch(0.18 0.022 245)",
        sidebarForeground: "oklch(0.95 0.01 235)",
        sidebarPrimary: "oklch(0.75 0.12 230)",
        sidebarPrimaryForeground: "oklch(0.15 0.03 240)",
        sidebarAccent: "oklch(0.27 0.03 245)",
        sidebarAccentForeground: "oklch(0.95 0.01 235)",
        sidebarBorder: "oklch(1 0 0 / 6%)",
        sidebarRing: "oklch(0.75 0.12 230)",
      },
      {
        id: "sky-blue-light",
        name: "Sky Blue Light",
        variant: "light",
        primary: "oklch(0.52 0.13 235)",
        accent: "oklch(0.7 0.11 235)",
        background: "oklch(0.98 0.006 235)",
        foreground: "oklch(0.2 0.02 245)",
        card: "oklch(1 0 0)",
        cardForeground: "oklch(0.2 0.02 245)",
        popover: "oklch(1 0 0)",
        popoverForeground: "oklch(0.2 0.02 245)",
        primaryForeground: "oklch(0.99 0 0)",
        secondary: "oklch(0.95 0.008 235)",
        secondaryForeground: "oklch(0.22 0.022 245)",
        muted: "oklch(0.95 0.008 235)",
        mutedForeground: "oklch(0.48 0.02 245)",
        destructive: "oklch(0.58 0.24 27)",
        border: "oklch(0.9 0.012 235)",
        input: "oklch(0.9 0.012 235)",
        ring: "oklch(0.52 0.13 235)",
        sidebar: "oklch(0.965 0.007 235)",
        sidebarForeground: "oklch(0.2 0.02 245)",
        sidebarPrimary: "oklch(0.52 0.13 235)",
        sidebarPrimaryForeground: "oklch(0.99 0 0)",
        sidebarAccent: "oklch(0.93 0.012 235)",
        sidebarAccentForeground: "oklch(0.22 0.022 245)",
        sidebarBorder: "oklch(0.9 0.012 235)",
        sidebarRing: "oklch(0.52 0.13 235)",
      },
    ],
  },
  defaults: {
