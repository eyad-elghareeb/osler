...
/**
 * Osler brand mark — the app icon (`public/assets/icon.svg`) as an inline
 * SVG: navy gradient tile, subtle medical cross, azure ECG pulse. Gradient
 * IDs are per-instance (React `useId`) so multiple marks on one page never
 * collide.
 */
export function OslerMark({ className, title }: OslerMarkProps) {
