...
import { SparkTrend } from "./analytics-spark";
...
function ProfileNoteCard({
  ...
  return (
    <div className="group rounded-xl border border-border bg-card hover:border-primary/40 hover:bg-primary/5 transition-colors p-3.5 cursor-pointer">
      ...
      <div className="flex items-center justify-end gap-1 mt-2 pt-2 border-t border-border opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
        {onOpenInQBank && (
          <button
            onClick={(e) => {
              e.stopPropagation();
