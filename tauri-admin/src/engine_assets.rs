...
// NOTE: The admin binary cannot embed itself (circular build dependency).
// Build the binary separately first, then set OSLER_ADMIN_BINARY_PATH env var
// to point to the pre-built binary. If unset, the constant is empty.
